<template>
  <div class="start">
    ...
    <div>
      <select name="trivia_amount" v-model="selectedAmount">
    ...
    <div>
      <select name="trivia_category" v-model="selectedCategory">
    ...
    <div>
      <select name="trivia_difficulty" v-model="selectedDifficulty">
